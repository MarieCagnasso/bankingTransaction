...
public class BankingTest {
	...
	public void successfulTransfer() throws Exception {
        ...
        public void errorTransfer () throws Exception{
            float amount = 200.0f;
            int fromCustomer = 0; // Le client 0 dispose de 100€ dans le jeu de tests
            int toCustomer = 1;
        ...
        @Test (expected = Exception.class)
        public void clientAUnknown () throws Exception{
            float amount = 10.0f;
            int fromCustomer = 2; // Le client 0 dispose de 100€ dans le jeu de tests
            int toCustomer = 1;
        ...
        @Test (expected = Exception.class)
        public void clientBUnknown () throws Exception{
            float amount = 10.0f;
            int fromCustomer = 0; // Le client 0 dispose de 100€ dans le jeu de tests
            int toCustomer = 10;
